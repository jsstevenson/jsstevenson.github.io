...
`*`_I've never used a good 2/3 of these languages and may well be messing up some of the details_
...
`*`_The dates are fuzzy - who knows when in language development a decision is made about syntax - but the point is pretty clear_

_`**`Python, of course, didn't ship with annotation ability - PEP 3107 added annotion capabilities, and PEP 484 integrated their use for type hinting_
